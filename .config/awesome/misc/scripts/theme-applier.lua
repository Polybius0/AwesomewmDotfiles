...
if require("theme.ui_vars").color_scheme == "light" then
        ...
        if output == "light" then
            ...
            # alacritty color
            sed -i '3s/.*/import = [\x27~\/.config\/alacritty\/colors-light.toml\x27]/g' ~/.config/alacritty/alacritty.toml
        ...
        if output == "dark" then
            ...
            # alacritty color
            sed -i '3s/.*/import = [\x27~\/.config\/alacritty\/colors-material.toml\x27]/g' ~/.config/alacritty/alacritty.toml
